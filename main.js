...
function init() {
    ...
    var hh = {    //init()函数里面前面的哈希对象hh
        ...
        'p': undefined,
        'a': 'acfun.tv',
        's': 'www.sina.com',//https://www.sohu.com./
        'z': 'zhihu.com',
        'm': 'www.mcdonalds.com.cn',//https://www.mgtv.com/
        'd':'www.douyu.com',//https://developer.mozilla.org
        'h':'www.huya.com',
        'g':'www.google.com',
        'b':'www.bilibili.com',//https://www.baidu.com/
        'f':'www.facebook.com',//https://developer.mozilla.org
        'c':'www.cctv.com',
